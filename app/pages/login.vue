    ...
    <div class="col-md-5 col-lg-4">
      <div class="card">
        ...
        <div class="auth-card-header">
          ...
          <h4 class="mb-0 fw-bold text-white">Welcome back</h4>
          <p class="mb-0 mt-1" style="color:rgba(255,255,255,0.6);font-size:.875rem">Log in to your TaskFlow account</p>
        </div>
        ...
        <div class="card-body p-4">
          ...
          <p class="mt-3 text-center small" style="color:rgba(255,255,255,0.45)">
            ...
            <RouterLink to="/register" style="color:#64b5f6">Register</RouterLink>
          </p>
        </div>
      </div>
    </div>
